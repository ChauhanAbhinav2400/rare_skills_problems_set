...
//     // 1️⃣ compute rewards before changing balance
//     uint256 rewards = _computeRewards(
//         user.balance,
//         user.debt,
//         accumulatedRewardsPerDepositTokenWAD
//     );
...
//     // 3️⃣ update debt
//     user.debt =
//         (user.balance * accumulatedRewardsPerDepositTokenWAD) / WAD;
...
//     require(amount <= user.balance, "withdraw amount exceeds balance");
...
//       DepositInfo memory user = deposits[account];

//     uint256 newAcc = accumulatedRewardsPerDepositTokenWAD +
//         _increaseInAccumulatedRewardsPerTokenSinceLastUpdate();
...
//         deltaTime * rewardPerDepositTokenPerSecond;

//     return (totalRewards * WAD) / totalDeposits;
//     }
// }
