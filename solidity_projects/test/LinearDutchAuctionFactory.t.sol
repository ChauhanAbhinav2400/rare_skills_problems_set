...
import {LinearDutchAuction, LinearDutchAuctionFactory} from "../src/LinearDutchAuctionFactory.sol";
...
contract LinearDutchAuctionTest is Test {
    ...
    function test_buy_tokens_seller_revert() public {
        ...
        token.transfer(address(seller),100e18);
