...
contract Crowdfunding {
    ...
    event CancelContribution(address indexed contribution , uint256 amount);
    ...
    function contribute(uint256 amount) external {
        ...
        require(token.balanceOf(address(this)) < fundingGoal, "Funding goal already reached");
...
if(contributed == 0 ) {
    revert("No contributions to cancel");
}
